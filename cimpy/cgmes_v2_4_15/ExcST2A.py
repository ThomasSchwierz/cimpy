...
class ExcST2A(ExcitationSystemDynamics):
	...
	:ta: Voltage regulator time constant (Ta).  Typical Value = 0.15. Default: 0
	...
	:te: Exciter time constant, integration rate associated with exciter control (Te).  Typical Value = 0.5. Default: 0
	:kf: Excitation control system stabilizer gains (Kf).  Typical Value = 0.05. Default: 0.0
	:tf: Excitation control system stabilizer time constant (Tf).  Typical Value = 0.7. Default: 0
