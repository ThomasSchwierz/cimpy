...
class WindGenTurbineType3bIEC(WindGenTurbineType3IEC):
	...
	:tg: Current generation Time constant (). It is type dependent parameter. Default: 0
	:two: Time constant for crowbar washout filter (). It is case dependent parameter. Default: 0
	...
	def __init__(self, fducw = 0.0, tg = 0, two = 0, mwtcwp = False, xs = 0.0,  *args, **kw_args):
