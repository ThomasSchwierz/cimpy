...
class ExcST1A(ExcitationSystemDynamics):
	...
	:tc1: Voltage regulator time constant (Tc).  Typical Value = 0. Default: 0
	:tb1: Voltage regulator time constant (Tb).  Typical Value = 0. Default: 0
	...
	def __init__(self, vimax = 0.0, vimin = 0.0, tc = 0, tb = 0, ka = 0.0, ta = 0, vrmax = 0.0, vrmin = 0.0, kc = 0.0, kf = 0.0, tf = 0, tc1 = 0, tb1 = 0, vamax = 0.0, vamin = 0.0, ilr = 0.0, klr = 0.0, xe = 0.0,  *args, **kw_args):
