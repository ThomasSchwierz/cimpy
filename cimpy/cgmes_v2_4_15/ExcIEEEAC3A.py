...
class ExcIEEEAC3A(ExcitationSystemDynamics):
	...
	:ta: Voltage regulator time constant (T).  Typical Value = 0.013. Default: 0
	...
	:te: Exciter time constant, integration rate associated with exciter control (T).  Typical Value = 1.17. Default: 0
