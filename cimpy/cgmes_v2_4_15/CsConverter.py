...
class CsConverter(ACDCConverter):
	...
	def __init__(self, maxAlpha = 0.0, maxGamma = 0.0, maxIdc = 0.0, minAlpha = 0.0, minGamma = 0.0, minIdc = 0.0, ratedIdc = 0.0, operatingMode = None, pPccControl = None, targetAlpha = 0.0, targetGamma = 0.0, targetIdc = 0.0, alpha = 0.0, gamma = 0.0,  *args, **kw_args):
