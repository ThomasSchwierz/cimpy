...
class DiagramObject(IdentifiedObject):
	...
	def __init__(self, Diagram = None, drawingOrder = 0, isPolygon = False, offsetX = 0.0, offsetY = 0.0, rotation = 0.0, IdentifiedObject = None, DiagramObjectPoints = "list", VisibilityLayers = "list", DiagramObjectStyle = None,  *args, **kw_args):
