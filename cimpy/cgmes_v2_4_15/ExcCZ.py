...
class ExcCZ(ExcitationSystemDynamics):
	...
	:tc: Regulator integral time constant (Tc). Default: 0
	...
	:ta: Regulator time constant (Ta). Default: 0
	:ke: Exciter constant related to self-excited field (Ke). Default: 0.0
	:te: Exciter time constant, integration rate associated with exciter control (Te). Default: 0
	...
	def __init__(self, kp = 0.0, tc = 0, vrmax = 0.0, vrmin = 0.0, ka = 0.0, ta = 0, ke = 0.0, te = 0, efdmax = 0.0, efdmin = 0.0,  *args, **kw_args):
