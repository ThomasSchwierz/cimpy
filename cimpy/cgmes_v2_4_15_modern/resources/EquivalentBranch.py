...
class EquivalentBranch(EquivalentEquipment):
    ...
    x21: Reactance from terminal sequence 2 to terminal sequence 1 .Used for steady state power flow. This attribute is
      optional and represent unbalanced network such as off-nominal phase shifter. If only EquivalentBranch.x
      is given, then EquivalentBranch.x21 is assumed equal to EquivalentBranch.x. Usage rule : EquivalentBranch
      is a result of network reduction prior to the data exchange.
    ...
    negativeR12 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    negativeR21 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    negativeX12 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    negativeX21 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    positiveR12 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    positiveR21 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    positiveX12 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    positiveX21 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    r : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    r21 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    x : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    x21 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    zeroR12 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    zeroR21 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    zeroX12 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    zeroX21 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 
