...
class ExcAVR2(ExcitationSystemDynamics):
    """
    Italian excitation system corresponding to IEEE (1968) Type 2 Model. It represents alternator and rotating diodes
    ...
    ta: AVR time constant (T).  Typical Value = 0.02.
    ...
    tf1: Rate feedback time constant (T).  Typical Value = 1.
    tf2: Rate feedback time constant (T).  Typical Value = 1.
    """
