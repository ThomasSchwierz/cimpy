...
class MutualCoupling(IdentifiedObject):
    ...
    First_Terminal : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    Second_Terminal : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    b0ch : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    distance11 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    distance12 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    distance21 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    distance22 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 
