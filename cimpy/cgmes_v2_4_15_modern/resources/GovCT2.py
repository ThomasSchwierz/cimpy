...
class GovCT2(TurbineGovernorDynamics):
    """
    General governor model with frequency-dependent fuel flow limit.  This model is a modification of the GovCT1model in
    ...
    tpelec: Electrical power transducer time constant (Tpelec).  Typical Value = 2.5.
    maxerr: Maximum value for speed error signal (Maxerr).  Typical Value = 1.
    minerr: Minimum value for speed error signal (Minerr).  Typical Value = -1.
    ...
    vmin: Minimum valve position limit (Vmin).  Typical Value = 0.175.
    tact: Actuator time constant (Tact).  Typical Value = 0.4.
    kturb: Turbine gain (Kturb).  Typical Value = 1.9168.
    wfnl: No load fuel flow (Wfnl).  Typical Value = 0.187.
    tb: Turbine lag time constant (Tb).  Typical Value = 0.1.
    ...
    teng: Transport time delay for diesel engine used in representing diesel engines where there is a small but
      ...
      Typical Value = 0.
    tfload: Load Limiter time constant (Tfload).  Typical Value = 3.
    ...
    ropen: Maximum valve opening rate (Ropen).  Unit = PU/sec.  Typical Value = 99.
    rclose: Minimum valve closing rate (Rclose).  Unit = PU/sec.  Typical Value = -99.
    ...
    aset: Acceleration limiter setpoint (Aset).  Unit = PU/sec.  Typical Value = 10.
    ka: Acceleration limiter Gain (Ka).  Typical Value = 10.
    ta: Acceleration limiter time constant (Ta).  Typical Value = 1.
    ...
    tsa: Temperature detection lead time constant (Tsa).  Typical Value = 0.
    tsb: Temperature detection lag time constant (Tsb).  Typical Value = 50.
    ...
    prate : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    flim1 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    plim1 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    flim2 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    plim2 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    flim3 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    plim3 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    flim4 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    plim4 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    flim5 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    plim5 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    flim6 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    plim6 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    flim7 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    plim7 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    flim8 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    plim8 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    flim9 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    plim9 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    flim10 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    plim10 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 
