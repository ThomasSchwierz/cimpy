...
class CoordinateSystem(IdentifiedObject):
    ...
    crsUrn: A Uniform Resource Name (URN) for the coordinate reference system (crs) used to define
      ...
      urn:ogc:def:uom:EPSG::XXXX, where XXXX is an EPSG code (a full list of codes can be found at the EPSG
      Registry web site http://www.epsg-registry.org/). To define the coordinate system as being WGS84
      (latitude, longitude) using an EPSG OGC, this attribute would be urn:ogc:def:uom:EPSG::4236. A profile
    ...
    crsUrn : str = Field(default="", json_schema_extra={"in_profiles":[Profile.GL, ]}) 

    # *Association not used*
    # Type M:0..n in CIM
    # Location : list = Field(default_factory=list, json_schema_extra={"in_profiles":[Profile.GL, ]}) # noqa: E501
