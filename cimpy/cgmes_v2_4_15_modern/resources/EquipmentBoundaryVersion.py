...
class EquipmentBoundaryVersion(Base):
    ...
    entsoeURIcore: Profile URI defined by ENTSO-E and used in the Model Exchange header.  It uniquely identifies the
      ...
      (http://entsoe.eu/CIM/EquipmentBoundary/yy/zzz) indicate major and minor versions where:  - yy
    ...
    entsoeURIoperation: Profile URI defined by ENTSO-E and used in the Model Exchange header.  It uniquely identifies
      ...
      (http://entsoe.eu/CIM/EquipmentBoundaryOperation/yy/zzz) indicate major and minor versions
    ...
    baseUML : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 

    baseURI : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 

    date : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 

    differenceModelURI : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 

    entsoeUML : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 

    entsoeURIcore : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 

    entsoeURIoperation : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 

    modelDescriptionURI : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 

    namespaceRDF : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 

    namespaceUML : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 

    shortName : str = Field(default="", json_schema_extra={"in_profiles":[Profile.EQ_BD, ]}) 
