...
class WindGenTurbineType1IEC(WindTurbineType1or2IEC):
    ...
    WindAeroConstIEC: Wind aerodynamic model associated with this wind turbine type 1 model.
    """

    WindAeroConstIEC : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.DY, ]}) 
