...
class GovHydroDD(TurbineGovernorDynamics):
    ...
    td: Input filter time constant (Td).  Typical Value = 0.
    tf: Washout time constant (Tf).  Typical Value = 0.1.
    tp: Gate servo time constant (Tp).  Typical Value = 0.35.
    velop: Maximum gate opening velocity (Velop).  Unit = PU/sec.  Typical Value = 0.09.
    velcl: Maximum gate closing velocity (Velcl).  Unit = PU/sec.  Typical Value = -0.14.
    ...
    tturb: Turbine time constant (Tturb) (note 3).  Typical Value = 0.8.
    aturb: Turbine numerator multiplier (Aturb) (note 3).  Typical Value = -1.
    bturb: Turbine denominator multiplier (Bturb) (note 3).  Typical Value = 0.5.
    tt: Power feedback time constant (Tt).  Typical Value = 0.02.
    ...
    tturb : int = Field(default=0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 
