...
class StaticVarCompensator(RegulatingCondEq):
    ...
    capacitiveRating: Maximum available capacitive reactance.
    inductiveRating: Maximum available inductive reactance.
    slope: The characteristics slope of an SVC defines how the reactive power output changes in proportion to the
      difference between the regulated bus voltage and the voltage setpoint.
    ...
    capacitiveRating : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    inductiveRating : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    slope : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    sVCControlMode : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    voltageSetPoint : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 
