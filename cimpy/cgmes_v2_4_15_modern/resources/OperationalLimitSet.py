...
class OperationalLimitSet(IdentifiedObject):
    ...
    OperationalLimitValue: The limit set to which the limit values belong.
    """

    Terminal : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 

    Equipment : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 
