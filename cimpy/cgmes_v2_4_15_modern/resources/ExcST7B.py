...
class ExcST7B(ExcitationSystemDynamics):
    ...
    kh: High-value gate feedback gain (Kh).  Typical Value = 1.
    kia: Voltage regulator integral gain (Kia).  Typical Value = 1.
    kl: Low-value gate feedback gain (Kl).  Typical Value = 1.
    kpa: Voltage regulator proportional gain (Kpa).  Typical Value = 40.
    oelin: OEL input selector (OELin). Typical Value = noOELinput.
    tb: Regulator lag time constant (Tb).  Typical Value = 1.
    tc: Regulator lead time constant (Tc).  Typical Value = 1.
    tf: Excitation control system stabilizer time constant (Tf).  Typical Value = 1.
    tg: Feedback time constant of inner loop field voltage regulator (Tg).  Typical Value = 1.
    tia: Feedback time constant (Tia).  Typical Value = 3.
    ts: Rectifier firing time constant (Ts).  Typical Value = 0.
    uelin: UEL input selector (UELin). Typical Value = noUELinput.
    vmax: Maximum voltage reference signal (Vmax).  Typical Value = 1.1.
    vmin: Minimum voltage reference signal (Vmin).  Typical Value = 0.9.
    vrmax: Maximum voltage regulator output (Vrmax).  Typical Value = 5.
    vrmin: Minimum voltage regulator output (Vrmin).  Typical Value = -4.5.
    """
