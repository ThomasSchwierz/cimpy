...
class PositionPoint(Base):
    ...
    Set of spatial coordinates that determine a point, defined in the coordinate system specified in
      'Location.CoordinateSystem'. Use a single position point instance to desribe a point-oriented location. Use a
    ...
    sequenceNumber : int = Field(default=0, json_schema_extra={"in_profiles":[Profile.GL, ]}) 

    xPosition : str = Field(default="", json_schema_extra={"in_profiles":[Profile.GL, ]}) 

    yPosition : str = Field(default="", json_schema_extra={"in_profiles":[Profile.GL, ]}) 

    zPosition : str = Field(default="", json_schema_extra={"in_profiles":[Profile.GL, ]}) 
