...
class SvPowerFlow(Base):
    ...
    Terminal : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.SV, ]}) 

    p : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.SV, ]}) 

    q : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.SV, ]}) 
