...
class GovSteam0(TurbineGovernorDynamics):
    ...
    t1: Steam bowl time constant (T1).  Typical Value = 0.5.
    vmax: Maximum valve position, PU of mwcap (Vmax).  Typical Value = 1.
    vmin: Minimum valve position, PU of mwcap (Vmin).  Typical Value = 0.
    t2: Numerator time constant of T2/T3 block (T2).  Typical Value = 3.
    t3: Reheater time constant (T3).  Typical Value = 10.
