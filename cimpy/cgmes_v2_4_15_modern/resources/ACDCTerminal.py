...
class ACDCTerminal(IdentifiedObject):
    ...
    BusNameMarker : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.EQ, ]}) 
    ...
    connected : bool = Field(default=False, json_schema_extra={"in_profiles":[Profile.SSH, ]}) 
    ...
    def possible_profiles(self)->set[BaseProfile]:
        ...
        """
        return { Profile.DY, Profile.EQ, Profile.SV, Profile.SSH, Profile.TP,  }
