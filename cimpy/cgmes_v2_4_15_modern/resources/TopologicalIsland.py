...
class TopologicalIsland(IdentifiedObject):
    ...
    AngleRefTopologicalNode : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.SV, ]}) 

    TopologicalNodes : list = Field(default_factory=list, json_schema_extra={"in_profiles":[Profile.SV, ]}) 
