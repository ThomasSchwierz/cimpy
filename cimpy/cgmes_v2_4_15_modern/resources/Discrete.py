...
class Discrete(Measurement):
    ...
    DiscreteValues: Measurement to which this value is connected.
    ValueAliasSet: The ValueAliasSet used for translation of a MeasurementValue.value to a name.
    """

    # *Association not used*
    # Type M:0..n in CIM
    # DiscreteValues : list = Field(default_factory=list, json_schema_extra={"in_profiles":[Profile.EQ, ]}) # noqa: E501
