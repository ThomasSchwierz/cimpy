...
class ExcST2A(ExcitationSystemDynamics):
    ...
    ka: Voltage regulator gain (Ka).  Typical Value = 120.
    ta: Voltage regulator time constant (Ta).  Typical Value = 0.15.
    vrmax: Maximum voltage regulator outputs (Vrmax).  Typical Value = 1.
    vrmin: Minimum voltage regulator outputs (Vrmin).  Typical Value = -1.
    ke: Exciter constant related to self-excited field (Ke).  Typical Value = 1.
    te: Exciter time constant, integration rate associated with exciter control (Te).  Typical Value = 0.5.
    kf: Excitation control system stabilizer gains (Kf).  Typical Value = 0.05.
    tf: Excitation control system stabilizer time constant (Tf).  Typical Value = 0.7.
    kp: Potential circuit gain coefficient (Kp).  Typical Value = 4.88.
    ki: Potential circuit gain coefficient (Ki).  Typical Value = 8.
    kc: Rectifier loading factor proportional to commutating reactance (Kc).  Typical Value = 1.82.
    efdmax: Maximum field voltage (Efdmax).  Typical Value = 99.
