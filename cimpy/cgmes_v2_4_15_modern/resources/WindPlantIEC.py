...
class WindPlantIEC(WindPlantDynamics):
    ...
    WindPlantReactiveControlIEC: Wind plant reactive control model associated with this wind plant.
    """

    WindPlantFreqPcontrolIEC : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    WindPlantReactiveControlIEC : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.DY, ]}) 
