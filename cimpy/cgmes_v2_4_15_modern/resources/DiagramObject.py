...
class DiagramObject(IdentifiedObject):
    ...
    IdentifiedObject: The diagram objects that are associated with the domain object.
    ...
    Diagram : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.DL, ]}) 

    drawingOrder : int = Field(default=0, json_schema_extra={"in_profiles":[Profile.DL, ]}) 

    isPolygon : bool = Field(default=False, json_schema_extra={"in_profiles":[Profile.DL, ]}) 

    offsetX : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DL, ]}) 

    offsetY : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DL, ]}) 

    rotation : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DL, ]}) 

    IdentifiedObject : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.DL, ]}) 
    ...
    DiagramObjectStyle : Optional[str] = Field(default=None, json_schema_extra={"in_profiles":[Profile.DL, ]}) 
