...
class GovSteam1(TurbineGovernorDynamics):
    """
    Steam turbine governor model, based on the GovSteamIEEE1 model  (with optional deadband and nonlinear valve gain
      added).
    ...
    sdb1 : bool = Field(default=False, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    sdb2 : bool = Field(default=False, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    db2 : float = Field(default=0.0, json_schema_extra={"in_profiles":[Profile.DY, ]}) 

    valve : bool = Field(default=False, json_schema_extra={"in_profiles":[Profile.DY, ]}) 
