...
class OverexcLimX1(OverexcitationLimiterDynamics):
    ...
    efdrated: Rated field voltage (EFD).  Typical Value = 1.05.
    efd1: Low voltage point on the inverse time characteristic (EFD).  Typical Value = 1.1.
    t1: Time to trip the exciter at the low voltage point on the inverse time characteristic (TIME).  Typical Value =
      120.
    efd2: Mid voltage point on the inverse time characteristic (EFD).  Typical Value = 1.2.
    t2: Time to trip the exciter at the mid voltage point on the inverse time characteristic (TIME).  Typical Value =
      40.
    efd3: High voltage point on the inverse time characteristic (EFD).  Typical Value = 1.5.
    t3: Time to trip the exciter at the high voltage point on the inverse time characteristic (TIME).  Typical Value =
      15.
    efddes: Desired field voltage (EFD).  Typical Value = 0.9.
    kmx: Gain (K).  Typical Value = 0.01.
